...
public class EventHandler {
	...
	public void checkEvent() {
		...
		if(canTouchEvent) {
			...
			else if(hit(0,10,39,"any") == true) {teleport(1,12,13,gp.dialogueState);}
			else if(hit(1,12,13,"any") == true) {teleport(0,10,39,gp.dialogueState);}
		}
	...
	public void healingPool(int gameState) {
		...
		if(gp.keyH.enterPressed == true) {
			...
			gp.playSE(2);
			gp.ui.currentDialogue = "You drink the water.\nYour status had been recovered.";
